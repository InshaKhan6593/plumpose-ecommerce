...
const PIECES: DemoPiece[] = [
  // ------------------------------------------------------------ pyjama sets
  {
    ...
    priceQar: 1150,
    slug: 'noir-piped-set',
    title: 'Noir — Piped Silk Pyjama Set',
    description:
      'Deep black silk with fine white piping at the collar, cuffs and pocket. A long shirt and full-length trousers, cut to move with you.',
    photos: [6976706, 6976713, 6976714, 6976739],
    stock: { L: 6, M: 10, S: 8 },
    madeToOrder: false,
  ...
  },
  {
    ...
    colour: 'Blush',
    priceQar: 1250,
    slug: 'blush-lounge-set',
    title: 'Blush — Silk Lounge Set',
    description:
      'A soft blush set with a relaxed shirt and wide trousers, for slow mornings and late evenings alike.',
    photos: [7162014, 7162023, 7162013],
    stock: { L: 0, M: 2, S: 1 },
    madeToOrder: false,
    personalisation: true,
  },
  {
    ...
    colour: 'Ivory',
    priceQar: 980,
    slug: 'ivory-shirt-shorts',
    title: 'Ivory — Silk Shirt & Shorts',
    description:
      'An oversized ivory shirt with a tie-waist short. Light as air for the summer months.',
    photos: [20356192, 20356180, 20356176, 20356189],
    stock: { L: 0, M: 0, S: 0 },
    madeToOrder: false,
    personalisation: true,
  },
  {
    ...
    priceQar: 1299,
    slug: 'terracotta-set',
    title: 'Terracotta — Silk Pyjama Set',
    description:
      'A warm, burnt-orange silk that catches the evening light. Notched collar, long trousers.',
    photos: [33672397],
    stock: { L: 5, M: 5, S: 5 },
    personalisation: true,
  },
  {
    ...
    priceQar: 1199,
    slug: 'emerald-set',
    title: 'Emerald — Silk Pyjama Set',
    description:
      'Jewel-green silk in the signature silhouette, with covered buttons and a relaxed leg.',
    photos: [9499298],
    stock: { L: 3, M: 4, S: 2 },
    madeToOrder: false,
    personalisation: true,
  },
  {
    ...
    colour: 'Dove Grey',
    priceQar: 850,
    slug: 'dove-grey-cami-set',
    title: 'Dove Grey — Cami & Trouser Set',
    description:
      'A bias-cut camisole with fine straps and a matching wide trouser in dove-grey silk.',
    photos: [6976322, 6976440],
    stock: { L: 6, M: 6, S: 6 },
  },
  {
    collection: 'sets',
    colour: 'Midnight',
    priceQar: 1350,
    slug: 'midnight-mens-set',
    title: 'Midnight — Men’s Piped Pyjama Set',
    description:
      'For him: a classic long-sleeved shirt and trouser in midnight silk, finished with white piping.',
    photos: [20364758, 20364755],
    stock: { L: 3, M: 3, S: 3 },
    personalisation: true,
  },
  {
    ...
    colour: 'Sage',
    priceQar: 1199,
    slug: 'sage-resort-set',
    title: 'Sage — Short-Sleeve Resort Set',
    description:
      'Short sleeves and a camp collar in sage-green silk. Made to order for each customer.',
    photos: [32343659, 32343663],
    stock: { L: 0, M: 0, S: 0 },
    personalisation: true,
  },
  {
    ...
    colour: 'Scarlet',
    priceQar: 890,
    slug: 'scarlet-sleep-shirt',
    title: 'Scarlet — Silk Sleep Shirt',
    description:
      'A long, loose sleep shirt in scarlet silk with a curved hem. Ready in M; S and L are made to order.',
    photos: [20356220, 20356223, 20356199, 20356183],
    stock: { L: 0, M: 3, S: 0 },
  },
  ...
  // ------------------------------------------------------------------ robes
  {
    ...
    priceQar: 1050,
    slug: 'onyx-wrap-robe',
    title: 'Onyx — Silk Wrap Robe',
    description:
      'A long black wrap robe with wide sleeves and a self-tie belt. The easiest thing to reach for.',
    photos: [8244572, 8244563, 8244565, 8244559],
    stock: { L: 4, M: 4, S: 4 },
    madeToOrder: false,
    personalisation: true,
  },
  {
    ...
    colour: 'Pearl',
    priceQar: 1150,
    slug: 'pearl-bridal-robe',
    title: 'Pearl — Bridal Silk Robe',
    description:
      'A pearl-white robe for the morning of the wedding. Add her initials in gold thread.',
    photos: [9197309, 9197313],
    stock: { L: 1, M: 1, S: 2 },
    madeToOrder: false,
    personalisation: true,
  },
  {
    ...
    colour: 'Rose',
    priceQar: 1450,
    slug: 'rose-lace-robe-set',
    title: 'Rose — Lace-Trimmed Robe Set',
    description:
      'A pale rose robe and camisole set edged in black lace at the neckline, sleeves and hem.',
    photos: [20337341, 20337344, 20337355, 20337354],
    stock: { L: 2, M: 0, S: 3 },
    madeToOrder: false,
  },
  ...
  // ------------------------------------------------------------------ slips
  {
    ...
    colour: 'Champagne',
    priceQar: 780,
    slug: 'champagne-bias-slip',
    title: 'Champagne — Bias-Cut Slip',
    description:
      'A midi slip cut on the bias so it falls close without clinging. Cowl neck, fine straps.',
    photos: [12466608, 12466616, 12466603, 12466620],
    stock: { L: 5, M: 5, S: 5 },
  },
  {
    collection: 'slips',
  ...
  // ------------------------------------------------------------ accessories
  {
    ...
    colour: 'Cornflower',
    priceQar: 180,
    slug: 'cornflower-eye-mask',
    title: 'Cornflower — Silk Eye Mask',
    description: 'A padded silk eye mask with a soft elastic band. Kind to skin and lashes.',
    photos: [6541175, 6541213, 6541087, 6541108],
    stock: 20,
    personalisation: true,
  },
  {
    ...
    priceQar: 160,
    slug: 'pearl-eye-mask',
    title: 'Pearl — Silk Eye Mask',
    description: 'The silk eye mask in pearl. Sold out for now.',
    photos: [9832085, 9832083, 9832086],
    stock: 0,
    madeToOrder: false,
  },
  {
    ...
    title: 'Champagne — Silk Pillowcase',
    description:
      'A 22-momme silk pillowcase with an envelope closure. Less friction for hair and skin overnight.',
    photos: [16065663, 14380623, 14380626],
    stock: 12,
    madeToOrder: false,
  },
]
...
async function pexelsPhoto(id: number): Promise<{ file: string; meta: PexelsPhoto }> {
  ...
  fs.writeFileSync(
    metaFile,
    JSON.stringify({ alt: meta.alt, id: meta.id, photographer: meta.photographer, src: meta.src }),
  )
  return { file, meta }
}
...
async function seedDemo(payload: Payload) {
  ...
  const sizeOptions = Object.fromEntries(
    (
      await payload.find({
        ...
        limit: 10,
        where: { variantType: { equals: sizeType.id } },
      })
  ...
  for (const [key, title] of Object.entries(COLLECTIONS)) {
    ...
    const found = (
      await payload.find({ collection: 'categories', limit: 1, where: { slug: { equals: slug } } })
    ).docs[0]
    collectionIds[key] = (
      found ??
      (await payload.create({
        collection: 'categories',
        data: { generateSlug: false, slug, title } as any,
      }))
    ).id as number
  }
  ...
  for (const piece of PIECES) {
    ...
    if (
      (await payload.find({ collection: 'products', limit: 1, where: { slug: { equals: slug } } }))
        .docs[0]
    ) {
    ...
    const gallery = []
    for (const id of piece.photos)
      gallery.push({ image: await demoMedia(payload, id, piece.title) })
 ...
 */
async function seedTwoColourPiece(
  payload: Payload,
  sizeTypeId: number,
  sizeOptions: Record<Size, number>,
  collectionId: number,
) {
  ...
  const colourType = (
    await payload.find({
      collection: 'variantTypes',
      limit: 1,
      where: { name: { equals: 'Colour' } },
    })
  ).docs[0]
  if (!colourType)
    throw new Error('Run `pnpm seed` first — the Colour option type does not exist yet.')
  ...
  for (const label of ['Noir', 'Blush']) {
    ...
    colour[label] = (
      ...
      (await payload.create({
        collection: 'variantOptions',
        data: { label, value, variantType: colourType.id } as any,
      }))
    ).id as number
  }

  const gallery = []
  for (const id of [6976706, 6976713])
    gallery.push({
      image: await demoMedia(payload, id, 'Classic set in Noir'),
      variantOption: colour.Noir,
    })
  for (const id of [7162014, 7162023])
    gallery.push({
      image: await demoMedia(payload, id, 'Classic set in Blush'),
      variantOption: colour.Blush,
    })
  ...
  const product = await payload.create({
    ...
    data: {
      ...
      composition: '100% mulberry silk',
      description: para(
        'The classic set in two colours — deep noir, or a soft blush. Choose your colour and size.',
      ),
      enableVariants: true,
      fabric: 'in 19-momme silk',
      gallery,
...
async function idsStartingWith(
  ...
  return docs
    .filter((d: any) => String(d[field] ?? '').startsWith(prefix))
...
async function removeDemo(payload: Payload) {
  ...
  const demoColours = colours
    .filter((o: any) => String(o.value).startsWith(PREFIX))
    .map((o: any) => o.id)
  if (demoColours.length)
